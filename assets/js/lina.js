/*-----------------------------------------------------------
* Template Name    : Lina | Bootstrap 4 personal, portfolio and resume
* Author           : Retrinagroup
* Version          : 1.0.0
* Created          : March 2020
...
function pagePilling(){
    ...
    $('#pagepiling').pagepiling({
        sectionsColor: ['#f1f3f6', '#f1f3f6', '#f1f3f6', '#f1f3f6', '#f1f3f6','#f1f3f6', '#f1f3f6' ,'#f1f3f6'],
        ...
        navigation: {
            'position': 'right',
            'tooltips': ['خانه', 'درباره من', 'رزومه', 'خدمات', 'نمونه کار', 'مشتری', 'بلاگ', 'تماس', 'فوتر']
        },
        loopBottom: true,
        loopTop: true,
        scrollingSpeed: 700,
